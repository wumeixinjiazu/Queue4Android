...
import com.videocomm.queue4android.main.BussinessCenter;
import com.videocomm.queue4android.main.LoginActivity;
...
public class DialogFactory {
     ...
     * 获取指定类型的对话框实例
     *
     * @param dwDialogId 对话框类型
     * @param object     对话框数据参数
     * @param context    对话框位于的上下文
     * @return 对话框实例
     */
    ...
    public static Dialog getDialog(int dwDialogId, String tipContent,
                                   Activity context, OnClickListener listener) {
        mDialogFactory.initDialog(dwDialogId, tipContent, context, listener);
        return mDialog;
    }
    ...
    public void initDialog(int dwDialogId, String tipContent, Activity context, OnClickListener listener) {
        if (mContext != context) {
            mContext = context;
        ...
        switch (dwDialogId) {
            ...
            case DIALOGID_EXIT_QUEUE:
                initQuitDialg(mDialog, "您确定要" + tipContent + "吗？", listener);
                break;
    ...
    public void initQuitDialg(final Dialog dialog, String content, OnClickListener onClickListener) {
        View view = mLayoutInlater
                .inflate(R.layout.dialog_resumeorcancel, null);
